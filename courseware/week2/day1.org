...
* Including Javascript in the HTML                                 :noexport:
...
* How do we know if our code is working?                           :noexport:
...
* Exercise: A function that changes the class             :exercise:noexport:
...
* TODO JS: Problem 1: We're going to...                            :noexport:
...
* Exercise: Putting it all together                       :exercise:noexport:
...
* Just for fun: =mousemove=                                        :noexport:
...
#+BEGIN_SRC asciitosvg
 ...
 NotePad++      vAtom     SublimeText           VS Code     WebStorm
...
#+RESULTS:
[[file:integrated-development-environments-ide.svg]]
...
* TODO What's wrong with our code?                                 :noexport:
...
* TODO Refactoring: Inline Javascript                              :noexport:
...
#+END_NOTES
* TODO Refactoring: Repeated code                                  :noexport:
...
* TODO Refactoring: Event binding with =onclick=                   :noexport:

#+BEGIN_SRC html
... onlick="nameOfFunction(event)" ...
#+END_SRC
...
* Refactoring: Cleaning up =setClass()=                            :noexport:
...
* TODO Refactoring: Reflection                                     :noexport:
...
* TODO Changing the DOM tree with Javascript                       :noexport:
...
* Exercises: Changing the DOM tree                                 :noexport:
...
#+BEGIN_NOTES
See [[file:day5/][week2/day5 directory]] for details.

Goal is to introduce the =style= property on an element.
#+END_NOTES
