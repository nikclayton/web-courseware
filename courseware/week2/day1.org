...
#+BEGIN_NOTES
TODO(nik): Has the inspector been introduced by this point?
...
There are some variables that already exist in Javascript. =document= is one
of those variables. You don't need to declare it, it's already there,
waitinf for you to use it.
...
#+INCLUDE: "change_para_class/solution-1.html" :lines "21-37" src javascript
