...
#+INCLUDE: "shopping-multiple/shopping.html" :lines "8-10" src html
...
#+INCLUDE: "shopping-mvc/skeleton/src/html/index.html" :lines "8-13" src html

*** Control flow

- Page is loaded
  - =ui.js:domContentLoaded()= is run, =new Controller()=
