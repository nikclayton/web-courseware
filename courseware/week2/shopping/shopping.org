...
digraph G {
  ...
  span -> span_content;
  span_content [label="#t: Eggs" shape=none];
  button -> button_content;
  button_content [label="#t: Delete" shape=none];
}
#+END_SRC
...
#+BEGIN_SRC javascript -n :noweb yes
...
*** =remove()= and the DOM
 ...
 digraph G {
   ...
   span1 [label="span"];
   span1 -> span_content1;
   span_content1 [label="#t: Eggs" shape=none];
   button1 [label="button"];
   button1 -> button_content1;
   button_content1 [label="#t: Delete" shape=none];
   ...
   span2 [label="span"];
   span2 -> span_content2;
   span_content2 [label="#t: Milk" shape=none];
   button2 [label="button"];
   button2 -> button_content2;
   button_content2 [label="#t: Delete" shape=none];
   ...
   span3 [label="span"];
   span3 -> span_content3;
   span_content3 [label="#t: Bread" shape=none];
   button3 [label="button"];
   button3 -> button_content3;
   button_content3 [label="#t: Delete" shape=none];
 }
 #+END_SRC
...
#+END_SRC
 ...
 digraph G {
   ...
   span_content2 [label="#t: Milk" style=invis shape=none];
   button2 [label="button" style=invis];
   button2 -> button_content2 [style=invis];
   button_content2 [label="#t: Delete" style=invis shape=none];
...
** Solution: Disabling the button

#+INCLUDE: "shopping-7.js" :lines "26-30" src javascript -n

** Solution: Disabling the button

#+INCLUDE: "shopping-7.js" :lines "31-39" src javascript -n

** Solution: Disabling the button

#+INCLUDE: "shopping-7.js" :lines "40-56" src javascript -n
