...
#+INCLUDE: "shopping-15.js" :lines "37-50" src javascript
...
#+INCLUDE: "shopping-19.js" :lines "45-46" src javascript

#+INCLUDE: "shopping-19.js" :lines "51-60" src javascript

#+BEGIN_NOTES
Here's the code that finds the quantity widget.

In the click listener I pass the trimmed value to =createNewListItem=. I don't bother saving the result in to a variable, since I don't need to test the value.
