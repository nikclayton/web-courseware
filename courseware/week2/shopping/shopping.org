...
#+INCLUDE: "shopping-15.js" :lines "70-77" src javascript
...
#+INCLUDE: "shopping-15.js" :lines "76-82" src javascript
...
*** =for= loop example
 ...
 for (const i = 0; i < a.length; i = i + 1) {
   console.log(a[i]);
 }
 #+END_SRC
...
** Restarting loops earlier than normal
 ...
 - Use =continue= to exit a loop sooner than normal
...
** Using a constuctor in our code
