...
The courseware is in the https://bitbucket.org/hussamallaham/004.powercoders/src/master/courseware/ repository and directory. Ask Hussam for access if you don't already
have it.
