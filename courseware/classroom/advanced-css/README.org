...
#+INCLUDE: "samples/box-model.html" src html
...
#+iNCLUDE: "samples/box-model-2.html" :lines "8-19" src html

** Add some HTML content

#+NAME: box-model-2
#+BEGIN_SRC html-chrome :url (shell-quote-argument (expand-file-name "samples/box-model-2.html")) :flags --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+NAME: box-model-3
#+BEGIN_SRC html-chrome :cache no :url (shell-quote-argument (expand-file-name "samples/box-model-3.html")) :flags --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
First, remember how the first element in our page is always =html=.
...
#+REVEAL_HTML: <div class="rightcol">
#+NAME: box-model-4
#+BEGIN_SRC html-chrome :cache no :url (shell-quote-argument (expand-file-name "samples/box-model-4.html")) :flags --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+REVEAL_HTML: <div class="rightcol">
#+NAME: box-model-5
#+BEGIN_SRC html-chrome :cache no :url (shell-quote-argument (expand-file-name "samples/box-model-5.html")) :flags --window-size=320,400 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+REVEAL_HTML: <div class="rightcol">
#+NAME: box-model-6
#+BEGIN_SRC html-chrome :cache no :url (shell-quote-argument (expand-file-name "samples/box-model-6.html")) :flags --window-size=380,400 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+BEGIN_NOTES
There are various predefined styles that you can use for borders, they
...
#+NAME: display
#+INCLUDE: "samples/display.html" src html

** =display= examples

#+INCLUDE: "samples/display.css" src css

** =display= examples

#+REVEAL_HTML: <div class="leftcol">
#+BEGIN_SRC html-chrome :cache no :url (shell-quote-argument (expand-file-name "samples/display.html")) :flags --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
** =breadcrumb.html=
 ...
 #+INCLUDE: "samples/display-2.html" src html

*** Result

#+REVEAL_HTML: <div class="leftcol">
#+BEGIN_SRC html-chrome :cache no :url (shell-quote-argument (expand-file-name "samples/display-2.html")) :flags --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+REVEAL_HTML: <div class="leftcol">
#+INCLUDE: "samples/display-3.css" :lines "6-9" src css
#+REVEAL_HTML: </div>
...
#+REVEAL_HTML: <div class="leftcol">
#+INCLUDE: "samples/display-3.css" :lines "6-13" src css
#+REVEAL_HTML: </div>
...
#+REVEAL_HTML: <div class="leftcol">
#+INCLUDE: "samples/display-3.css" :lines "6-17" src css
#+REVEAL_HTML: </div>
...
#+REVEAL_HTML: <div class="leftcol">
#+INCLUDE: "samples/display-3.css" src css
#+REVEAL_HTML: </div>
...
#+REVEAL_HTML: <div class="leftcol">
#+NAME: display-3
#+BEGIN_SRC html-chrome :cache yes :url (shell-quote-argument (expand-file-name "samples/display-3.html")) :flags --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+INCLUDE: "samples/position-1.html" src html

** Add some HTML content

#+INCLUDE: "samples/position-2.html" :lines "8-19" src html
...
#+NAME: position-2
#+BEGIN_SRC html-chrome :url (shell-quote-argument (expand-file-name "samples/position-2.html")) :flags --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+REVEAL_HTML: <div class="leftcol">
#+INCLUDE: "samples/position-3.css" src css
#+REVEAL_HTML: </div>

#+REVEAL_HTML: <div class="rightcol">
#+NAME: position-3
#+BEGIN_SRC html-chrome :url (shell-quote-argument (expand-file-name "samples/position-3.html")) :flags --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+INCLUDE: "samples/position-4.css" src css
...
#+NAME: position-4
#+BEGIN_SRC html-chrome :url (shell-quote-argument (expand-file-name "samples/position-4.html")) :flags --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+REVEAL_HTML: <div class="rightcol">
#+INCLUDE: "samples/position-5.css" src css
#+REVEAL_HTML: </div>
...
Make this change to the stylesheet, and see what happens.
...
#+REVEAL_HTML: <div class="rightcol">
#+NAME: position-5
#+BEGIN_SRC html-chrome :url (shell-quote-argument (expand-file-name "samples/position-5.html")) :flags --window-size=320,320 --force-device-scale-factor=2 --hide-scrollbars :exports results
#+END_SRC
...
#+INCLUDE: "samples/position-6.css" src css
...
#+NAME: position-6
#+BEGIN_SRC html-chrome :url (shell-quote-argument (expand-file-name "samples/position-6.html")) :flags --hide-scrollbars --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+REVEAL_HTML: <div class="rightcol">
#+INCLUDE: "samples/position-7.css" src css
#+REVEAL_HTML: </div>
...
#+REVEAL_HTML: <div class="rightcol">
#+NAME: position-7
#+BEGIN_SRC html-chrome :url (shell-quote-argument (expand-file-name "samples/position-7.html")) :flags --window-size=320,320 --force-device-scale-factor=2 --hide-scrollbars :exports results
#+END_SRC
...
#+REVEAL_HTML: <div class="leftcol">
#+INCLUDE: "samples/position-8.css" src css
#+REVEAL_HTML: </div>

#+REVEAL_HTML: <div class="rightcol">
#+NAME: position-8
#+BEGIN_SRC html-chrome :url (shell-quote-argument (expand-file-name "samples/position-8.html")) :flags --window-size=320,320 --force-device-scale-factor=2 --hide-scrollbars :exports results
#+END_SRC
...
#+INCLUDE: "samples/3column/3column.html" src html
...
#+BEGIN_SRC html-chrome :cache yes :url (shell-quote-argument (expand-file-name "samples/3column/3column.html")) :flags --window-size=320,320 --force-device-scale-factor=2 :exports results
#+END_SRC
...
#+INCLUDE: "samples/3column/3column-1.css" src css
...
#+NAME: 3column-1
#+BEGIN_SRC html-chrome :cache yes :url (shell-quote-argument (expand-file-name "samples/3column/3column-1.html")) :flags --window-size=866,600 --force-device-scale-factor=1.5 :exports results
#+END_SRC
...
#+INCLUDE: "samples/3column/3column-2.css" :lines "15-21" src css
...
#+NAME: 3column-2
#+BEGIN_SRC html-chrome :cache yes :url (shell-quote-argument (expand-file-name "samples/3column/3column-2.html")) :flags --window-size=866,600 --force-device-scale-factor=1.5 :exports results
#+END_SRC
...
#+INCLUDE: "samples/3column/3column-3.css" :lines "22-28" src css

#+BEGIN_NOTES
This should be pretty straightforward by now.

We position the secondary content div absolutely, and 1em from the left
...
#+NAME: 3column-3
#+BEGIN_SRC html-chrome :cache yes :url (shell-quote-argument (expand-file-name "samples/3column/3column-3.html")) :flags --window-size=866,600 --force-device-scale-factor=1.5 :exports results
#+END_SRC
...
#+NAME: 3column-4
#+BEGIN_SRC html-chrome :cache yes :url (shell-quote-argument (expand-file-name "samples/3column/3column-4.html")) :flags --window-size=866,600 --force-device-scale-factor=1.5 :exports results
#+END_SRC
...
#+INCLUDE: "samples/3column/3column-4.css" :lines "29-36" src css
...
** 3-column exercises: Portfolio example            :noexport:exercise:

#+NAME: 3column-portfolio
#+BEGIN_SRC html-chrome :cache yes :url (shell-quote-argument (expand-file-name "samples/3column/3column-portfolio.html")) :flags --window-size=866,600 --force-device-scale-factor=1.5 :exports results
#+END_SRC
...
#+NAME: 3column-recipe
#+BEGIN_SRC html-chrome :cache yes :url (shell-quote-argument (expand-file-name "samples/3column/3column-recipe.html")) :flags --window-size=866,600 --force-device-scale-factor=1.5 :exports results
#+END_SRC
...
- Experiment creating 3-column layout with both of these
...
Both of them make achieving some types of layouts much simpler. MDN has excellent documentation and tutorials for both of them.

Read more about it at https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Grid_Layout -- start with that page, and then read the articles linked to from the left of the page under "Guides" ("Basic concepts of grid layout", etc).

Try the =grid= game at http://cssgridgarden.com/ to practice.

Try the Flexbox Froggy game at https://flexboxfroggy.com/.

If you think you can simplify any of your page stylesheets, or make layouts easier by using CSS grid or flexbox then try updating the stylesheet to use it, and experiment.
#+end_notes
...
#+BEGIN_CENTER
[[file:samples/display-4.html][Breadcrumb with media query]]
#+END_CENTER
...
#+INCLUDE: "samples/display-4.html" :lines "6-7" src html
...
#+INCLUDE: "samples/display-4.css" :lines "1-5" src css
...
#+INCLUDE: "samples/display-4.css" :lines "6-19" src css
...
#+INCLUDE: "samples/display-4.css" :lines "20-44" src css
...
Or should I design for smaller screen first, and then show content
