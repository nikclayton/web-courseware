...
* Exercises: Changing the DOM tree                                 :exercise:
...
#+begin_notes
The solution to this is in =samples/add-para=.
#+end_notes
...
#+begin_notes
The solution to this, with comments for the teacher, is in =samples/add-list=.
#+end_notes

** Hiding and showing ingredients

- Very common to have parts of the page appear or disappear
 - E.g., menus, e-mail compose boxes, dialog boxes, etc
- In your recipes, change the "ingredients" section
 - Default: It's shown, with a "-" next to it
 - Click the "-"
  - The ingredients are hidden
  - The "-" is hidden and replaced with a "+"
 - Click the "+"
  - The ingredients are shown
  - "The "+" is hidden and replaced with a "-"

#+begin_notes
Show this in action by loading =hide_show_ingredients/index.html=

Break the problem down:
 - Update the HTML with a "-"
 - Detect the click on the "-", make sure it works
 - Hide the ingredients list (ask them how, hint the CSS =display= property)
 - Hide the "-", show the "+"
#+end_notes
